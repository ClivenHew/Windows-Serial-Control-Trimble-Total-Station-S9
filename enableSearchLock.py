...
def enable_search_lock(trimbleSerial, logFile, status):
    commandTimeout = 10

    expectedResponse = (b"\x12\x08\x00\x02\x01\x98\x80\x00\xC0")
    trimbleBuffer = bytearray()
    commandBytes = [0x13, 0x07, 0x00, 0x01, 0x02, 0x98, 0x40, 0xC0]
