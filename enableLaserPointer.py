...
def enable_laser_pointer(trimbleSerial, logFile, status):
    try:
        commandTimeout = 10
        state = 0
        ...
        while True:
            match state:
                case 0:
                    ...
                    commandBytes = [0x13, 0x08, 0x00, 0x01, 0x02, 0x72, 0x40, 0x01, 0xC0]
